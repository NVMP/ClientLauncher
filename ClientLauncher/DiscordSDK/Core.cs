...
namespace Discord
{
    ...
    public partial class ApplicationManager
    {
        ...
        /* NV:MP Fix, https://github.com/discord/gamesdk-and-dispatch/issues/36 */
        static FFIMethods.GetOAuth2TokenCallback static_GCHold = GetOAuth2TokenCallbackImpl;

        public void GetOAuth2Token(GetOAuth2TokenHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            Methods.GetOAuth2Token(MethodsPtr, GCHandle.ToIntPtr(wrapped), static_GCHold);
        }
